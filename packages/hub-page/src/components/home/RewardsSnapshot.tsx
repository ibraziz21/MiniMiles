// No "use client" needed — TrackedLink is itself the client boundary (see
// MerchantRail.tsx/MerchantValueCard.tsx for the same server-component
// pattern), and this component no longer has any client-only state of its
// own now that NextRewardCard has moved out.
 ...
 * discovery, not before it. Next Reward Progress V1 now renders as its own
 * standalone card near the top of Explore (NextRewardCard.tsx,
 * discovery-blueprint.md §3) rather than nested here — this card just shows
 * balance / active vouchers / Pass, never duplicating that content.
 */
