        ...
        {intents.map((intent, i) => {
          ...
          return (
            <TrackedLink
              ...
              className="group flex min-h-20 min-w-0 flex-col items-center justify-center gap-2 rounded-2xl border border-akiba-line bg-white px-1.5 py-3 text-center text-[11px] font-semibold leading-tight text-akiba-ink transition hover:-translate-y-0.5 hover:border-akiba-teal/40 hover:shadow-chip focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-akiba-teal sm:min-h-24 sm:px-2 sm:text-xs"
            >
