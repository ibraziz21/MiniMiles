// ISO-week helpers — verbatim copy of packages/react-app/lib/games/week.ts.
// No shared package exists between react-app and hub-page (same duplication
// pattern already used for the HMAC webhook scheme between quest-events.ts
// and sponsoredGameWebhook.ts); spec §5 "Sponsored leaderboard" requires the
// same ISO-week convention as react-app, so this must stay byte-identical to
// that file if it's ever updated.
