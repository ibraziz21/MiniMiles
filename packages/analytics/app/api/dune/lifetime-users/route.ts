...
const DEFAULT_QUERY_ID = "5667458";
const DEFAULT_COLUMN = "lifetime_users";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const queryId = process.env.DUNE_LIFETIME_USERS_QUERY_ID || DEFAULT_QUERY_ID;
    const column = process.env.DUNE_LIFETIME_USERS_COLUMN || DEFAULT_COLUMN;
    ...
    const value = firstRow && typeof firstRow === "object"
    ...
    console.error("[analytics/dune/lifetime-users]", error);
    return NextResponse.json(
