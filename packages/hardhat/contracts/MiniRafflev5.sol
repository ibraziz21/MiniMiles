...
contract AkibaRaffleV5 is UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function drawWinner(
        ...
        uint256 threshold = (uint256(r.maxTickets) * 10) / 100;
    ...
    function closeRaffle(
        ...
        require(
            round.totalTickets * 100 < uint256(round.maxTickets) * 10,
    ...
    function buildChunks(
        ...
        require((block.timestamp > r.endTime)||(r.maxTickets == r.totalTickets), "Raffle: not ended");
        require(!r.winnerSelected, "Raffle: already drawn");
