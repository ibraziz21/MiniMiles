...
contract AkibaRaffleV6 is UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function drawWinner(
        ...
        uint256 threshold = (uint256(r.maxTickets) * 5) / 100;
    ...
    function closeRaffle(
        ...
        require(
            round.totalTickets * 100 < uint256(round.maxTickets) * 5,
