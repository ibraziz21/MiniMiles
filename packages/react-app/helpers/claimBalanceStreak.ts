...
const BALANCE_STREAK_100_QUEST_ID = "b5c7e1d2-6f8a-4b0c-9d2e-3a1f7c5b8e4d";
...
export async function claimBalanceStreak100(addr: string) {
  return postBalanceStreak(addr, BALANCE_STREAK_100_QUEST_ID, "100");
}
