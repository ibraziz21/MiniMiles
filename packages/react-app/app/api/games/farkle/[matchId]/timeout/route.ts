...
export async function POST(req: Request, { params }: Ctx) {
  ...
  if (matchError) {
    console.error("[farkle/timeout] failed to complete match", matchError);
  ...
  return NextResponse.json({ ok: true, winnerId: address, reason: "timeout" });
}
