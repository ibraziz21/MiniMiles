...
export function BuyPlaysSheet({ open, onClose, gameType, creditStatus, onBuy, buying, buyError }: Props) {
  ...
  async function handleBuy() {
    ...
    try {
      ...
      // buyError is owned by the hook and rendered below.
    }
  }
          ...
          <>
            ...
            <div className="pb-2 pt-2 text-center">
              ...
              <button
                type="button"
                onClick={handleClose}
                className="mt-5 w-full rounded-2xl bg-[#0D7A8A] py-3.5 text-sm font-bold text-white transition-all active:scale-[0.98]"
              >
                Done
              </button>
            </div>
