...
import ppSuccess from "@/public/svg/streak.svg";
...
export const StreakInfoSheet: FC<Props> = ({
    open,
    onOpenChange,
    onDone,
}) => {
                ...
                <div className="px-6 pt-6 pb-8">
                    ...
                    <div className="mx-auto flex w-full max-w-[312px] flex-col gap-8">
                        ...
                        <div className="relative">
                            ...
                            Complete the task daily to unlock extra AkibaMiles.


                            </p>
                            <p className="mt-2 text-[16px] leading-[22px] tracking-[-0.26px] text-[#4B5563]">• 1.2x rewards after 3x Streak</p>
                            <p className="mt-2 text-[16px] leading-[22px] tracking-[-0.26px] text-[#4B5563]">• 1.5x rewards after 10x Streaks</p>
