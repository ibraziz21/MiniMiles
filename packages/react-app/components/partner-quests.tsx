    ...
    quests: [
      {
        ...
        description: 'Check out Pretium site sign up using referral code AKIBA1. Miles awarded after Pretium verifies your account.',
        reward: '50 akibaMiles',
        color: '#EEF6FF',
        actionLink: 'https://pretium.africa/',
        instructions: [
          { title: 'Visit Pretium', text: 'Go to the Pretium website and sign up using referral code AKIBA1.' },
