...
const EarnPartnerQuestSheet = ({ open, onOpenChange }: PartnerQuestSheetProps) => {
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent side={"bottom"} className="bg-white rounded-t-xl font-poppins">
                <div className="bg-white">
                    ...
                    <h4 className='text-2xl font-bold'>First payment</h4>
                    ...
                    <Button title="Close"
                        onClick={() => { }} className="w-full rounded-xl py-6 flex items-center justify-center gap-3 font-semibold tracking-wide shadow-sm text-[#07955F] bg-[#07955F1A] hover:bg-[#07955F1A]
                    disabled:bg-[#07955F]"></Button>
